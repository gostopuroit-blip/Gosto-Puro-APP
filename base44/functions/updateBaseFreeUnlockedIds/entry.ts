...
const UNLOCKED_IDS = {
  ...
  "Proteiche": ["69c533335ef39af7da2996f8","69c53280319135f21a067ec4","69c5320b623e8af747119831","69bc4807d96dcba4d21cf6a7","69bc47c5046054434f63cf8c","69bc475c383d621b47ce5923","69bc46e36c9dd3a865c84cf9","69bc467eb5127ac042b044c9","69ad90188ca81f42ada009bf"],
...
Deno.serve(async (req) => {
  try {
    ...
    // Find and update the final config
    const configs = await base44.asServiceRole.entities.AppConfig.filter({ key: "base_free_unlocked_ids_final" });
    if (configs.length > 0) {
