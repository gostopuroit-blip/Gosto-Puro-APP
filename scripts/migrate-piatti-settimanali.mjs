/**
 * Migra as 50 receitas "Piatti Settimanali in Air Fryer" do base44 para o Supabase:
...
const recipes = JSON.parse(readFileSync('./scripts/piatti_settimanali.json', 'utf8'));
...
async function main() {
  console.log(`🚀 Migrando ${recipes.length} receitas "Piatti Settimanali in Air Fryer"\n`);
