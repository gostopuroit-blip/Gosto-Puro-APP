  ...
  return (
    <article className="bg-white dark:bg-[#1A1A1A] sm:rounded-2xl sm:border border-gray-100 dark:border-[#333] overflow-hidden">
      ...
      <div className="flex items-center gap-4 px-3.5 pt-2.5">
        ...
        <button onClick={shareWhatsApp} className="flex items-center active:scale-90 transition" aria-label="Condividi su WhatsApp">
          <svg viewBox="0 0 24 24" className="w-[25px] h-[25px] fill-[#25D366]" aria-hidden="true">
