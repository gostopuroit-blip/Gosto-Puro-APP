...
export default function PremiumGate({ children, user, feature = "questa funzionalità" }) {
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center bg-white/10 backdrop-blur-sm rounded-2xl z-10 px-4 py-8 text-center pointer-events-auto">
